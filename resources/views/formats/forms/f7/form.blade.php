...
<div class="container mt-5 mb-5">
    <div class="card shadow">
        <div class="card-header pt-4">
            <h4 class="card-title"><i class="fa fa-icon-list"></i> Formulario de formato F7</h4>
        </div>
        ...
        <div class="card-content">
            <div class="card-body">
                <div class="form form-horizontal">
                    <div class="form-body">
                        <form method="POST" action="{{route('form.storef7')}}">
                            @csrf
                            <div class="row justify-content-center">
                                <div class="col-sm-7">
                                    ...
                                    <div class="form-group">
                                        ...
                                        {!!$errors->first('modalidad', '<span style="color:#FA4747;" class="error-validate">:message</span>')!!}
                                    </div>
                                    <div class="form-group">
