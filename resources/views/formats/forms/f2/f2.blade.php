...
<body>
    ...
    <main>
        ...
        <div class="contenido">
            Por este medio nos dirigimos a usted con la finalidad de solicitarle tenga a bien nombrar la Comisión Revisora para que evalúe el Anteproyecto del Trabajo Recepcional titulado: “{{$alumno['trabajo']}}”, con número de folio: {{$alumno['folio']}}. <br><br>

            Para tal efecto nos permitimos anexar a la presente tres tantos impresos del anteproyecto con el visto bueno de los profesores que nos apoyaron en la asesoría: {{$alumno['maestro1']}}<br>  y {{$alumno['maestro2']}}, así como del profesor de la asignatura: {{$alumno['masig']}}. <br><br>
